...
export function* aggregate<K, V>(
    iterator: IterableIterator<[K, V]> | IterableIterator<any>,
): IterableIterator<[K, V[]]> | IterableIterator<any> {
...
export function* iterateBySqrt<T>(
    iterable: IterableIterator<T>,
): IterableIterator<T> {
